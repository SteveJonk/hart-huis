...
| 20:55 | demo-content.ts + site.ts herschreven naar plausibele filler-copy voor een verzonnen studio ("Fieldnote") i.p.v. instructie-achtige placeholders; 5e stap en 2 extra FAQ's toegevoegd zodat lijsten gevuld ogen | template/app/src/lib/{demo-content,site}.ts, template/README.md | tsc + eslint groen; fixture-build rendert alle 10 blocks met de nieuwe copy | ~25k |
