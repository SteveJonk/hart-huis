...
- [Geplande taken](docs/geplande-taken.md) — hoe de twee imports elke nacht
  aangeroepen worden (Coolify, Vercel of Sanity), en waar je in de studio
  nakijkt wat er gedraaid heeft.
