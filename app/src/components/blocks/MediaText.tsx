...
import { OVER_ONS_BUITEN } from '@/lib/over-ons-content';
...
const DEFAULTS: Required<MediaTextProps> = {
  ...
  cta: OVER_ONS_BUITEN.cta,
  image: OVER_ONS_BUITEN.image,
};
      ...
      >
        <Reveal>
          ...
          {paragraphs.map((paragraph) => (
            <p
              key={paragraph}
              className='mb-[18px] max-w-[46ch] leading-[1.75] text-ink-70 max-sm:max-w-none'
            >
              {paragraph}
            </p>
          ))}
